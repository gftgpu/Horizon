...
class AdditionalFeatureTypes(object):
    """
    Attributes:
     - int_features
    """
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.BOOL, 'int_features', None, False, ),  # 1
    )

    def __init__(self, int_features=thrift_spec[1][4],):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.BOOL:
                    self.int_features = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('AdditionalFeatureTypes')
        if self.int_features is not None:
            oprot.writeFieldBegin('int_features', TType.BOOL, 1)
            oprot.writeBool(self.int_features)
            oprot.writeFieldEnd()
...
class RLParameters(object):
    ...
    thrift_spec = (
        ...
        (14, TType.DOUBLE, 'predictor_rtol_check', None, 5e-005, ),  # 14
...
class RainbowDQNParameters(object):
    ...
    thrift_spec = (
        ...
        (2, TType.BOOL, 'dueling_architecture', None, False, ),  # 2
    )

    def __init__(self, double_q_learning=thrift_spec[1][4], dueling_architecture=thrift_spec[2][4],):
...
class DiscreteActionModelParameters(object):
    ...
    def __init__(self, actions=None, rl=None, training=None, action_budget=None, rainbow=None, state_feature_params=None, target_action_distribution=None, evaluation=thrift_spec[11][4],):
...
class ContinuousActionModelParameters(object):
    ...
    def __init__(self, rl=None, training=None, rainbow=None, evaluation=thrift_spec[6][4],):
        self.rl = rl
        self.training = training
        self.rainbow = rainbow
...
class DDPGTrainingParameters(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.I32, 'minibatch_size', None, 128, ),  # 1
...
class OpenAIGymParameters(object):
    ...
    def __init__(self, num_episodes=thrift_spec[1][4], max_steps=thrift_spec[2][4], train_every_ts=thrift_spec[3][4], train_after_ts=thrift_spec[4][4], test_every_ts=thrift_spec[5][4], test_after_ts=thrift_spec[6][4], num_train_batches=thrift_spec[7][4], avg_over_num_episodes=thrift_spec[8][4],):
